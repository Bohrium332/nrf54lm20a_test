...
- Write contract (same as peripheral): logical LED state `0` = LED OFF, `1` = LED ON
...
2. Enter this folder
3. This copy is configured to use:
...
4. Press `sw0` on the central board: the central should print `GATT write ok`, the peripheral should print `rx write: led_value=...`, and the peripheral LED should change
