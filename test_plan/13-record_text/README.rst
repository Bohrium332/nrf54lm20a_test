...
.. tabs::
   ...
   .. group-tab:: XIAO nRF54LM20A
      ...
      1. Build the sample for ``xiao_nrf54lm20a/nrf54lm20a/cpuapp`` with ``-DBOARD_ROOT=/disk/E/git_file/platform-seeedboards/zephyr``.
      #. Program the board and connect the NFC antenna to **P1.01/NFC1** and **P1.02/NFC2**.
      #. Touch the antenna with the smartphone or tablet and observe that the **blue LED** is lit.
      #. Observe that the smartphone or tablet displays the encoded text (in the most suitable language).
      #. Move the smartphone or tablet away from the NFC antenna and observe that the **blue LED** turns off.
